...
define(function (require, exports, module) {
    ...
    //module.exports = {
    return {
        SystemType: window.SystemType = "WebSite",
        WebRoot: window.WebRoot = '/',
        JsRoot: window.JsRoot = '/scripts/',
        PicRoot: window.PicRoot = '/images/',
        WcfRoot: window.WcfRoot = "http://api.muyingzhijia.me/",
        Restful: window.Restful = restful,
        EmailGroup: emails
    };
