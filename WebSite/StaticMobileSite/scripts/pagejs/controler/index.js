...
define(function (require, exports, module) {
    ...
    exports.initalize = function () {
        ...
        var columnModel = require("../model/column");

        var columnA1Collection = Backbone.Collection.extend({
            url: function () {
                return 'http://api.muyingzhijia.me/cms.svc/get_columndata_list/WebSite/token/guid/654/uid/B-A1-A1/1/10';
            },
            localStorage: new Backbone.LocalStorage("columnA1"),
            model: columnModel,
        ...
        var collection = new columnA1Collection();
