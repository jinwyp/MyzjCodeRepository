    ...
    TextNode.prototype.get = function (d, param, element, deep) {
        ...
        while (true) {
            ...
            if ((lm != -1 && lm < rm) || (rm == -1)) {
                ...
                if (--nested === 0) {
                    if (sText >= 0) {
                        var sT = this._template.getBin().evaluateContent(d, param, element, s.substring(sText, rm + 1));
                        if (sT == "null") { sT = ""; } else { sT = sT; }
                        result += sT;
                        sText = -1;
                        sExpr = i + 1;
                    }
    ...
    */
    jQuery.fn.processTemplate = function (d, param, options) {
        return jQuery(this).each(function () {
            ...
            if (typeof(options)!="undefined" && typeof (options.append) != "undefined" && options.append == true)
