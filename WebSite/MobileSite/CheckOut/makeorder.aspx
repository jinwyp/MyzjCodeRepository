...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div data-role="content">
        ...
        <a id="online_pay" style="display: none;" data-role="button" url="<%= MobileSite.BaseLib.WebUrls.onlinepayment("{0}","{1}") %>" data-theme="a">继续完成在线支付 </a><a id="checkOrderDetail" data-role="button" href="#" data-theme="c">
                查看订单 </a>
