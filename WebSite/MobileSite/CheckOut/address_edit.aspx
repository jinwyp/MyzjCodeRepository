    ...
    <div data-role="navbar" data-iconpos="left">
        <ul>
            <li><a href="<%= MobileSite.BaseLib.WebUrls.shoppingcart() %>" data-theme="c" data-icon="check"
                rel="external">购物车</a> </li>
            <li><a href="<%= MobileSite.BaseLib.WebUrls.orderconfirm() %>" data-theme="c" data-icon="arrow-r"
                rel="external">提交订单</a> </li>
            <li><a href="<%= MobileSite.BaseLib.WebUrls.addresslist() %>" data-theme="e" data-icon="arrow-r"
                rel="external">选择收货地址</a> </li>
        </ul>
    </div>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Other" runat="server">
    <script src="<%= MobileSite.BaseLib.WebUrls.JsRoot() %>bk/jquery.validate.min.js"
